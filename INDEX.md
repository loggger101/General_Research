...
- **Round 3** (2026-09-18): all five domains deepened; 10 new items → total now 29: T1×16, T2×10, T3×3. Six full texts hosted this round (all access-verified live from this machine before recording), four recorded `open_not_pulled` with abstracts and the exact bot-block reason. Headline findings:
